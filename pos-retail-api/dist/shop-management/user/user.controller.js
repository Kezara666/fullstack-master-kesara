...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Found user', type: user_entity_1.User }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Log in a user by username and password' }),
    (0, swagger_1.ApiBody)({ type: login_dto_1.LoginDto }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User logged in successfully', type: user_entity_1.User }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Updated', type: user_entity_1.User }),
    __param(0, (0, common_1.Param)('id')),
